...
var require_error_helpers = __commonJS({
  "node_modules/tsyringe/dist/cjs/error-helpers.js"(exports) {
    ...
    function formatErrorCtor(ctor, paramIdx, error3) {
      ...
      return composeErrorMessage(`Cannot inject the dependency ${dep} of "${ctor.name}" constructor. Reason:`, error3);
    }
...
// src/presentation/routes/machine/machine-selling-point-post.ts
var machine_selling_point_post_exports = {};
__export(machine_selling_point_post_exports, {
  main: () => main
});
module.exports = __toCommonJS(machine_selling_point_post_exports);
...
var httpJsonBodyParserMiddleware = (opts = {}) => {
  ...
  const httpJsonBodyParserMiddlewareBefore = async (request) => {
    ...
    try {
      ...
      const error3 = createError(422, "Invalid or malformed JSON was provided");
      error3.cause = cause;
      throw error3;
    }
  };
...
// src/presentation/routes/machine/machine-selling-point-post.ts
var import_tsyringe20 = __toESM(require_cjs());
...
var HttpError2 = class extends Error {
  constructor(code, message, statusCode, error3, data) {
    super(message);
    this.code = code;
    this.message = message;
    this.statusCode = statusCode;
...
var BadRequestError = class extends HttpError2 {
  constructor(code = 1, message = "Erro ao realizar requisi\xE7\xE3o", error3, data) {
    super(code, message, 400 /* BAD_REQUEST */, data, error3);
    this.code = code;
    this.message = message;
    this.error = error3;
    this.data = data;
...
var InternalServerError = class extends HttpError2 {
  constructor(code = 98, message = "Erro interno no servidor", error3, data) {
    super(code, message, 500 /* INTERNAL_SERVER_ERROR */, data, error3);
    this.code = code;
    this.message = message;
    this.error = error3;
    this.data = data;
...
var LambdaHandler = class {
  ...
  async perform(event, allowedMethod, lambda, context) {
    ...
    try {
      ...
      console.error(JSON.stringify(error3, ["message", "stack"]));
      let httpError = error3;
      if (!(error3 instanceof HttpError2)) {
...
LambdaHandler = __decorateClass([
  ...
  __decorateParam(0, (0, import_tsyringe.inject)("EnvironmentVariables"))
], LambdaHandler);

// src/presentation/validators/machine/machine-selling-point.validator.ts
var console2 = __toESM(require("console"));
var MachineSellingPointValidator = class {
  constructor(json) {
    try {
      const { sellingPointId, machineId, conciliation, cnpj } = JSON.parse(
        JSON.stringify(json)
      );
      this.sellingPointId = sellingPointId;
      this.sellingPointId = machineId;
      ...
      throw new BadRequestError(
        ...
        e,
        "sellingPointId ou littleMachineId n\xE3o localizados"
      );
    }
  }
  isReady() {
    if (!this.machineId || !this.sellingPointId) {
      throw new BadRequestError(
        94,
        "Body n\xE3o identificado",
        "littleMachineId ou littleMachineId n\xE3o localizados"
      );
    }
  }
  isValid() {
...
MachineSellingPointService = __decorateClass([
  ...
  __decorateParam(0, (0, import_tsyringe2.inject)("CompanyService")),
  __decorateParam(1, (0, import_tsyringe2.inject)("MachineSellingPointRepository")),
  __decorateParam(2, (0, import_tsyringe2.inject)("ConciliationCompanyRepository")),
  __decorateParam(3, (0, import_tsyringe2.inject)("ConciliationRepository"))
...
var http_default = isHttpAdapterSupported && function httpAdapter(config2) {
  return new Promise(function dispatchHttpRequest(resolvePromise, rejectPromise) {
    ...
    if (config2.transport) {
      ...
      transport = isHttpsRequest ? import_https2.default : import_http.default;
    } else {
...
PointSalesRepository = __decorateClass([
  ...
  __decorateParam(0, (0, import_tsyringe8.inject)("DbProvider"))
...
UserNameRepository = __decorateClass([
  ...
  __decorateParam(0, (0, import_tsyringe9.inject)("DbProvider"))
], UserNameRepository);
...
var NotFoundError = class extends HttpError2 {
  constructor(code = 4, message = "Recurso n\xE3o encontrado", error3, data) {
    super(code, message, 404 /* NOT_FOUND */, data, error3);
    this.code = code;
    this.message = message;
    this.error = error3;
    this.data = data;
...
PointSalesAppService = __decorateClass([
  ...
  __decorateParam(1, (0, import_tsyringe11.inject)("PointSalesRepository")),
  __decorateParam(2, (0, import_tsyringe11.inject)("CompanyRepository"))
...
OfferAvailableService = __decorateClass([
  ...
  __decorateParam(0, (0, import_tsyringe13.inject)("HttpClientService"))
...
FeesBankDataService = __decorateClass([
  ...
  __decorateParam(0, (0, import_tsyringe14.inject)("CompanyService"))
], FeesBankDataService);
...
DbConnection = __decorateClass([
  ...
  __decorateParam(0, (0, import_tsyringe15.inject)("DbProvider"))
], DbConnection);
...
PostgresSQLProvider = __decorateClass([
  ...
  __decorateParam(0, (0, import_tsyringe16.inject)("Configuration"))
], PostgresSQLProvider);
...
// src/infrastructure/config/index.ts
import_tsyringe19.container.registerSingleton("Configuration", Configuration);
import_tsyringe19.container.registerSingleton(DbConnection.name, DbConnection);
import_tsyringe19.container.registerSingleton(
  "EnvironmentVariables",
  EnvironmentVariables
);
import_tsyringe19.container.registerSingleton(
...
import_tsyringe19.container.registerSingleton("DbProvider", PostgresSQLProvider);
import_tsyringe19.container.registerSingleton(
...
// src/presentation/controllers/machine/MachineController.ts
var MachineController = class {
  constructor() {
    this.machineSellingPointService = import_tsyringe19.container.resolve(
      MachineSellingPointService
    );
  }
  async sellingPointService(input) {
    const data = new MachineSellingPointValidator(input).isValid();
    await this.machineSellingPointService.execute(data);
  }
};

// src/presentation/routes/machine/machine-selling-point-post.ts
var lambdaHandler = import_tsyringe20.container.resolve(LambdaHandler);
var putPointOfSalesHandler = async (event) => lambdaHandler.perform(event, "POST", async () => {
  const controller = new MachineController();
  return new SuccessResponse(
    await controller.sellingPointService(event.body)
  );
});
...
reflect-metadata/Reflect.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=machine-selling-point-post.js.map
